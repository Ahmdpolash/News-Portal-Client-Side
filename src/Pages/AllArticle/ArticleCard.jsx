...
const ArticleCard = ({ article, isLoading }) => {
  ...
  return (
    <div>
      <div className="relative border-2 flex flex-col lg:flex-row  max-w-[48rem] lg:h-[300px] rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
        <div className="relative w-full lg:w-2/5 m-0  text-gray-700 bg-white rounded-r-none shrink-0 rounded-xl bg-clip-border">
          <img
            src={article?.image}
            alt="image"
